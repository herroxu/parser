...
import (
	...
	"github.com/herroxu/parser/gopacket/layers"
	"github.com/herroxu/parser/gopacket/pcap"
	"github.com/herroxu/parser/gopacket/tcpassembly"
	"io"
	"io/ioutil"
	"net/http"
	"os"
...
var decodeLazy = flag.Bool("lazy", false, "If true, use lazy decoding")
var decodeNoCopy = flag.Bool("nocopy", true, "If true, avoid an extra copy when decoding packets")
var printErrors = flag.Bool("printErrors", false, "If true, check for and print error layers.")
var printLayers = flag.Bool("printLayers", false, "If true, print out the layers of each packet")
var repeat = flag.Int("repeat", 5, "Read over the file N times")
var cpuProfile = flag.String("cpuprofile", "", "If set, write CPU profile to filename")
var url = flag.String("url", "http://www.ll.mit.edu/mission/communications/cyber/CSTcorpora/ideval/data/1999/training/week1/tuesday/inside.tcpdump.gz", "URL to gzip'd pcap file")
