...
import (
	...
	"github.com/herroxu/parser/gopacket/examples/util"
	"github.com/herroxu/parser/gopacket/ip4defrag"
	"github.com/herroxu/parser/gopacket/layers" // pulls in all layers decoders
	"github.com/herroxu/parser/gopacket/pcap"
	"github.com/herroxu/parser/gopacket/reassembly"
)
...
const timeout = time.Minute * 5     // Pending bytes: TODO: from CLI
